...
ACTIVITY_GOTO_MONTHLY_SIGN_IN = ButtonWrapper(
    ...
    cn=Button(
        file='./assets/cn/activity/monthly_sign_in/ACTIVITY_GOTO_MONTHLY_SIGN_IN.png',
        area=(15, 567, 150, 642),
...
MONTHLY_SIGN_IN_BUTTON = ButtonWrapper(
    ...
    cn=Button(
        file='./assets/cn/activity/monthly_sign_in/MONTHLY_SIGN_IN_BUTTON.png',
...
MONTHLY_SIGN_IN_HAVE_DONE = ButtonWrapper(
    ...
    cn=Button(
        file='./assets/cn/activity/monthly_sign_in/MONTHLY_SIGN_IN_HAVE_DONE.png',
