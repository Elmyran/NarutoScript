...
BACK_GAME_CHECK = ButtonWrapper(
    ...
    share=[
        ...
        Button(
            file='./assets/share/base/page/BACK_GAME_CHECK.4.png',
            area=(428, 187, 533, 224),
            search=(408, 167, 553, 244),
            color=(205, 167, 100),
            button=(428, 187, 533, 224),
        ),
        Button(
            file='./assets/share/base/page/BACK_GAME_CHECK.5.png',
            area=(325, 480, 361, 522),
            search=(305, 460, 381, 542),
            color=(214, 178, 123),
            button=(325, 480, 361, 522),
        ),
    ],
)
...
BATTLE_ORDER_GOTO_RANK = ButtonWrapper(
    name='BATTLE_ORDER_GOTO_RANK',
    share=Button(
        file='./assets/share/base/page/BATTLE_ORDER_GOTO_RANK.png',
        area=(1117, 658, 1217, 695),
        search=(1097, 638, 1237, 715),
        color=(99, 78, 14),
        button=(1117, 658, 1217, 695),
    ),
)
BATTLE_ORDER_RANK_CHECK = ButtonWrapper(
...
CHARACTER_SELECT_PAGE = ButtonWrapper(
    ...
    share=[
        Button(
            ...
            area=(706, 87, 794, 238),
            search=(686, 67, 814, 258),
            color=(211, 201, 160),
            button=(706, 87, 794, 238),
        ),
        Button(
            file='./assets/share/base/page/CHARACTER_SELECT_PAGE.2.png',
            area=(720, 93, 781, 202),
            search=(700, 73, 801, 222),
            color=(113, 99, 65),
            button=(720, 93, 781, 202),
        ),
        Button(
            file='./assets/share/base/page/CHARACTER_SELECT_PAGE.3.png',
            area=(725, 327, 783, 438),
            search=(705, 307, 803, 458),
            color=(216, 209, 178),
            button=(725, 327, 783, 438),
        ),
        Button(
            file='./assets/share/base/page/CHARACTER_SELECT_PAGE.4.png',
            area=(725, 348, 781, 442),
            search=(705, 328, 801, 462),
            color=(122, 107, 73),
            button=(725, 348, 781, 442),
        ),
    ],
)
...
CLOSE = ButtonWrapper(
    ...
    share=[
        ...
        Button(
            file='./assets/share/base/page/CLOSE.4.png',
            area=(1216, 9, 1280, 61),
        ...
        Button(
            file='./assets/share/base/page/CLOSE.8.png',
            area=(1186, 3, 1262, 69),
            search=(1166, 0, 1280, 89),
            color=(120, 67, 39),
            button=(1186, 3, 1262, 69),
        ),
    ],
)
DAILY_CHECK = ButtonWrapper(
    name='DAILY_CHECK',
    share=Button(
        file='./assets/share/base/page/DAILY_CHECK.png',
        area=(1, 0, 267, 125),
        search=(0, 0, 287, 145),
        color=(146, 109, 43),
        button=(1, 0, 267, 125),
...
MAIN_GOTO_BATTLE_ORDER = ButtonWrapper(
    ...
    share=Button(
        file='./assets/share/base/page/MAIN_GOTO_BATTLE_ORDER.png',
        area=(1199, 423, 1250, 492),
        search=(1179, 403, 1270, 512),
        color=(152, 137, 119),
        button=(1199, 423, 1250, 492),
    ),
)
...
MAIN_GOTO_DAILY = ButtonWrapper(
    ...
    share=Button(
        file='./assets/share/base/page/MAIN_GOTO_DAILY.png',
...
MAIN_GOTO_STORE = ButtonWrapper(
    ...
    share=Button(
        ...
        area=(1203, 232, 1244, 286),
        search=(1183, 212, 1264, 306),
        color=(178, 164, 141),
...
STORE_CHECK = ButtonWrapper(
    name='STORE_CHECK',
    share=Button(
        file='./assets/share/base/page/STORE_CHECK.png',
        area=(40, 3, 256, 88),
        search=(20, 0, 276, 108),
        color=(156, 107, 28),
        button=(40, 3, 256, 88),
