...
page_manual.link(MANUAL_GOTO_TASK_BUTTON,destination=page_mission)
...
page_manual.link(MANUAL_GOTO_TASK_BUTTON,destination=page_organization_panel)
...
page_manual.link(MANUAL_GOTO_TASK_BUTTON,destination=page_squad)
...
page_manual.link(MANUAL_GOTO_TASK_BUTTON,destination=page_cultivation)
...
page_manual.link(MANUAL_GOTO_TASK_BUTTON,destination=page_equipment)
...
page_manual.link(MANUAL_GOTO_TASK_BUTTON,destination=page_ninjutsu)
...
page_manual.link(MANUAL_GOTO_TASK_BUTTON,destination=page_mi_jing)
...
page_manual.link(MANUAL_GOTO_TASK_BUTTON,destination=page_ji_fen_sai)
